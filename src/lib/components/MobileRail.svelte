...
<TabAnchor href="/home/settings" selected={$page.url.pathname.includes('/home/settings')}>
    <div class={anchorStyles}>
        <Gear />
        <span>Settings</span>
    </div>
...
<TabAnchor href="/home/admin" selected={$page.url.pathname.includes('/home/admin')}>
    <div class={anchorStyles}>
        <Wrench />
        <span>Admin</span>
    </div>
